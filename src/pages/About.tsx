        ...
        <div className="container-wide grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <AnimatedSection delay={0.1}>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              GrandClean была основана в 2015 году с простой миссией — сделать
              профессиональный клининг доступным каждому жителю Ташкента.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-4">
              Сегодня мы — команда из более чем 80 проверенных специалистов,
              оснащённых современным оборудованием и экологичными средствами. Мы
              обслуживаем тысячи клиентов и постоянно совершенствуем качество
              наших услуг.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              Каждый клиент для нас — приоритет. Мы верим, что чистое
              пространство — это основа продуктивности, здоровья и хорошего
              настроения.
            </p>
          </AnimatedSection>
        </div>
